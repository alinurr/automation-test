...
public class MainPageObject {
    ...
    public void swipeUp(int timeOfSwipe)
    {
        ...
        Dimension size = (Dimension) driver.manage().window().getSize();
        int x = size.width / 2;
    ...
    public boolean isElementLocatedOnTheScreen(String locator)
    {
        ...
        int screen_siza_by_y = driver.manage().window().getSize().getHeight();
        return element_location_by_y < screen_siza_by_y;
    }
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message)
    {
        ...
        int point_to_click_x = (right_x - width) - 3;//на 3 пикселя левее чем полная ширина элемента
    ...
    public void swipeElementToLeft(String locator, String error_message)
    {
        ...
        action.waitAction(WaitOptions.waitOptions(Duration.ofSeconds(600)));
