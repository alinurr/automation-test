...
public class AuthorizationPageObject extends MainPageObject {
    private static final String
            LOGIN_BUTTON = "xpath://body/div/div/a[contains(@class, 'mw-ui-progressive')]",
    ...
    {
        this.waitForElementAndSendKeys(LOGIN_INPUT, login, "Cannot find and put a login the login input", 5);
